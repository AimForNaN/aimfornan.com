...
My energy levels are about one-third to one-fourth that of a normal person, though sometimes it feels even less than that.
I use a rolling walker to get around the house and am unfit for travel.
Many doctors couldn't find anything wrong with me; all tests came back unremarkable.
I say these things as a matter of fact, not to play the victim.

I've spent several years researching, experimenting, and running tests in an attempt to figure out what's wrong with me.
...
I merely seek for people to stop settling for less.
